...
class com.biswaljavas.rest.webservices.restfulwebservices.HelloWorldBean
```
...
public java.lang.String com.biswaljavas.rest.webservices.restfulwebservices.HelloWorldController.helloWorld()
- Mapped "{[/hello-world-bean],methods=[GET]}" onto 
public com.biswaljavas.rest.webservices.restfulwebservices.HelloWorldBean com.biswaljavas.rest.webservices.restfulwebservices.HelloWorldController.helloWorldBean()
- Mapped "{[/error]}" onto 
